---
name: kalibr
description: Autonomous execution path routing for OpenClaw agents. Kalibr hooks into your agent's runtime, reads live telemetry, and routes to the optimal model + tool + parameter combination — preventing failures, degradations, and cost spikes before they impact users.
